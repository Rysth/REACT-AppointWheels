...
function HomePage() {
  ...
  return (
    <section className="w-full md:h-screen md:w-4/5 md:absolute md:right-0">
      <article className="flex flex-col items-center justify-center h-full lg:gap-10 mx-auto">
